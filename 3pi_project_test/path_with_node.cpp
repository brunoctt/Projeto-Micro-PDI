...
char get_turn(char direction, int *robot_facing){
    ...
    // int conv_dir[size_of_direction];
    // int robot_direction = convert_coordinate(*robot_facing);
    // char turn[size_of_direction];
    ...
    // for (int i=0; i < size_of_direction; i++)
    //     conv_dir[i] = convert_coordinate(direction[i]);
        
        
    // for (int i=0; i < size_of_direction; i++){
    //     // Modulo 4 operation in case turn is negative
    //     int t = (4 + robot_direction - conv_dir[i]) % 4;
    //     turn[i] = convert_to_turn(t);
...
// 	char paths_matrix[number_of_vertices][number_of_vertices][2] = {
// 	    {'\0', "NE",'\0', '\0', '\0'},
// 	    {'W', '\0','N', 'E', 'S'},
// 	    {'\0', 'S','\0', '\0', '\0'},
// 	    {'\0', 'W','\0', '\0', '\0'},
...
// 	};
    ...
    // find_coordinate("NS", sizeof("ES")-1, &robot_facing);
// 	cout << "\n";
//     cout << robot_facing << " ";
	return 0;
}
